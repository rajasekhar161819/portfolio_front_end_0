...
export const Contact = ()=>{
    return <section id="contact" className="min-h-screen flex flex-col items-center justify-center relative">
        {/* <div className="mx-20px"> 
            <h1 className="text-4xl font-bold text-white-200 lg:max-w-[45vw]">
                Ready to take <span className="text-cyan-400"> your </span> digital 
                <span className="w-20px"> presence to the next level?</span> 
            </h1>
        ...
        <RevealOnScroll>
            <div className="flex flex-col items-center">
                <h1 className="text-4xl font-bold lg:max-w-[45vw] text-center">
                    Ready to take <span className="text-cyan-500">your </span> 
                ...
                <a href="mailto:nrajasekhar20015@gmail.com">
